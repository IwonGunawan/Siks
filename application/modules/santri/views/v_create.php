              ...
              <form action="<?=base_url($action);?>" method="post" class="form-horizontal">
                ...
                <div class="card-body card-block">
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9"><input type="text" name="status" class="form-control" value="<?=$status;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Anak ke</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="anak_ke" class="form-control" value="<?=$anak_ke;?>" ></div>
                      </div>
                      <div class="row form-group">
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9"><input type="text" name="asal_sekolah" class="form-control" value="<?=$asal_sekolah;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">diterima dikelas</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="diterima_dikelas" class="form-control" value="<?=$diterima_dikelas;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal diterima</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="tgl_terima" class="form-control floating-label" id="date2" value="<?=$tgl_terima;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Ayah</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="ayah" class="form-control" value="<?=$ayah;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pekerjaa Ayah</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="ayah_pekerjaan" class="form-control" value="<?=$ayah_pekerjaan;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Ibu</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="ibu" class="form-control" value="<?=$ibu;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pekerjaan Ibu</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="ibu_pekerjaan" class="form-control" value="<?=$ibu_pekerjaan;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Wali</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="wali" class="form-control" value="<?=$wali;?>" ></div>
                      </div>
                      <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pekerjaan Wali</label></div>
                          <div class="col-12 col-md-9"><input type="text" name="wali_pekerjaan" class="form-control" value="<?=$wali_pekerjaan;?>" ></div>
                      </div>
